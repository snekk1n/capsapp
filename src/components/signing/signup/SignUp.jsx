...
const SignUp = () => {
    ...
    return (
        <div className={'hero flex flex-col justify-between items-center'}>
            <Header/>
            <img className={'w-20 h-16 place-self-center'} src={logo} alt=""/>
            <div className={'flex items-center flex-col gap-2.5'}>
                <h2 className={'border-b text-3xl font-semibold w-80 h-20'}>Регистрация</h2>
                <div className={'border-b w-80 flex justify-between items-center'}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                            d="M20 20.7722V18.7722C20 17.7114 19.5786 16.6939 18.8284 15.9438C18.0783 15.1936 17.0609 14.7722 16 14.7722H8C6.93913 14.7722 5.92172 15.1936 5.17157 15.9438C4.42143 16.6939 4 17.7114 4 18.7722V20.7722"
                            stroke="#BDBDBD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path
                            d="M12 10.7722C14.2091 10.7722 16 8.98136 16 6.77222C16 4.56308 14.2091 2.77222 12 2.77222C9.79086 2.77222 8 4.56308 8 6.77222C8 8.98136 9.79086 10.7722 12 10.7722Z"
                            stroke="#BDBDBD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <input
            ...
            {isFormComplete && (
                <div className={'flex justify-between w-60 font-light text-sm pt-4'}>
                    <span className={'text-[#12121D]'}>Уже есть аккаунт?</span>
                    <Link to="/signin/">
                        <a href="#" className={'text-[#2566AF]'}>Войти</a>
                    </Link>
                </div>
            )}
            ...
            <Link to="/signin/">
                <button
                    className={`signup rounded-full h-14 w-56 font-bold ${
                        isFormComplete ? 'bg-[#FDDB16] text-white' : 'text-[#12121D4D]'
                    }`}
                >
                    Регистрация
                </button>
